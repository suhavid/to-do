            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select class ="form-control" id="status" name="status">
                        ...
                        <option value="1" {{ $todo->status == '1' ? 'selected':'' }}>Waiting</option>
                        <option value="2" {{ $todo->status == '2' ? 'selected':'' }}>On Process</option>
                        <option value="3" {{ $todo->status == '3' ? 'selected':'' }}>Done</option>
                    </select>
                </div>
            </div>
